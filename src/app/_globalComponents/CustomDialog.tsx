            ...
            <TransitionChild as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
              <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <DialogTitle as="h3" className="text-xl text-center font-medium leading-6 text-gray-900">
                  <p>Evento creado! </p><p>Por favor guardá el link.</p>
                </DialogTitle>
                <div className="mt-2">
                ...
                <div className="mt-4 flex w-full items-center justify-between">
                  <CopyToClipboard
                    ...
                    onCopy={(text: string, bool: boolean) => {
                      bool ? toast.success('Link copied!') : toast.error('Ups!, copy link manually please');
                    }}
                  >
                  ...
                  {/* <Link href={`https://api.whatsapp.com/send?text=${encodeURIComponent(linkToCopy)}`}>
                    <button
                      type="button"
