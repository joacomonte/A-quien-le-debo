...
export default function SelectSearchUser({
  ...
  return (
    <div className=" w-full">
      <Combobox value={whoPaid} onChange={handleWhoPaidChange}>
        <div className="relative z-30 mt-1 ">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Combobox.Options className="absolute z-30 mt-1 h-[170px] w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
